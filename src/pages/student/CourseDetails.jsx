            ...
            <div className='flex md:flex-row flex-col-reverse gap-10 items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
                ...
                <div className='max-w-xl z-10 text-gray-500'>
                    ...
                    <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
                        <p>{calculateRating(courseData)}</p> {/* Updated function name here */}
                        <div className='flex'>
                            {[...Array(5)].map((_, i) => (
                    ...
                    <div>
                        <p className='text-sm'> Course by <span className='text-blue-600 underline'>Smart Coding Learning System</span></p>
                    </div>
                </div>
                {/* Right column */}
                <div>
